...
const imageHandler = async (m, { conn, command, usedPrefix }) => {
    ...
    const api1 = "https://delirius-apiofc.vercel.app/nsfw/boobs";
    const api2 = "https://delirius-apiofc.vercel.app/nsfw/girls";
    ...
    try {
        ...
        const buttons = [
            {
                buttonId: `${usedPrefix}imagenesnsfw`,
...
imageHandler.command = /^imagenesnsfw$/i;
